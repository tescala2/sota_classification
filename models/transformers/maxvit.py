...
__all__ = ["MaxVit", "maxvit_t"]

model_urls = {
    'maxvit_t': 'https://download.pytorch.org/models/maxvit_t-bc5ab103.pth'
}
...
class RelativePositionalMultiHeadAttention(nn.Module):
    ...
    def get_relative_positional_bias(self) -> torch.Tensor:
        ...
        relative_bias = self.relative_position_bias_table[bias_index].view(self.max_seq_len, self.max_seq_len,
                                                                           -1)  # type: ignore
...
def maxvit_t(pretrained: bool = False, **kwargs: Any) -> MaxVit:
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['maxvit_t'])
