...
def vit_b_16(pretrained: bool = False, **kwargs: Any) -> VisionTransformer:
    """
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['vit_b_16'])
...
def vit_b_32(pretrained: bool = False, **kwargs: Any) -> VisionTransformer:
    """
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['vit_b_32'])
        now_state_dict = model.state_dict()
        now_state_dict.update(pretrained_state_dict)
        model.load_state_dict(now_state_dict, strict=False)
    return model
...
def vit_l_16(pretrained: bool = False, **kwargs: Any) -> VisionTransformer:
    """
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['vit_l_16'])
        now_state_dict = model.state_dict()
        now_state_dict.update(pretrained_state_dict)
        model.load_state_dict(now_state_dict, strict=False)
    return model
...
def vit_l_32(pretrained: bool = False, **kwargs: Any) -> VisionTransformer:
    """
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['vit_l_32'])
        now_state_dict = model.state_dict()
        now_state_dict.update(pretrained_state_dict)
        model.load_state_dict(now_state_dict, strict=False)
    return model
