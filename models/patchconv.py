...
from timm.models.layers import DropPath, to_2tuple, trunc_normal_, SqueezeExcite

__all__ = ['PatchConvnet', 'S60', 'S120', 'B60', 'B120', 'L60', 'L120']
...
def S60(pretrained: bool = False, **kwargs):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url='https://dl.fbaipublicfiles.com/deit/s60_224_1k.pth',
...
def S120(pretrained: bool = False, **kwargs):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url='https://dl.fbaipublicfiles.com/deit/s120_224_1k.pth',
            map_location="cpu", check_hash=True
        )
        checkpoint_no_module = {}
        for k in model.state_dict().keys():
...
def B60(pretrained: bool = False, **kwargs):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url='https://dl.fbaipublicfiles.com/deit/b60_224_1k.pth',
            map_location="cpu", check_hash=True
        )
        checkpoint_no_module = {}
        for k in model.state_dict().keys():
...
def B120(pretrained: bool = False, **kwargs):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url='https://dl.fbaipublicfiles.com/deit/b120_224_1k.pth',
            map_location="cpu", check_hash=True
        )
        checkpoint_no_module = {}
        for k in model.state_dict().keys():
