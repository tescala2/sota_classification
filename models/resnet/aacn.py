...
__all__ = ['ResNet', 'resnet18_aacn', 'resnet34_aacn', 'resnet50_aacn', 'resnet101_aacn', 'resnet152_aacn',
           'resnext50_32x4d_aacn', 'resnext101_32x8d_aacn', 'wide_resnet50_2_aacn', 'wide_resnet101_2_aacn']
...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        if not attention:
            ...
            self.conv2 = AACN_Layer(in_channels=width, out_channels=width, k=k, v=v, kernel_size=3, num_heads=num_heads,
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        if not attention:
            ...
            self.conv2 = AACN_Layer(in_channels=width, k=k, v=v, kernel_size=3, num_heads=num_heads,
                                    image_size=image_size, inference=inference)
...
def resnet18_aacn(pretrained: bool = False, **kwargs: Any) -> ResNet:
...
def resnet34_aacn(pretrained: bool = False, **kwargs: Any) -> ResNet:
...
def resnet50_aacn(pretrained: bool = False, **kwargs: Any) -> ResNet:
...
def resnet101_aacn(pretrained: bool = False, **kwargs: Any) -> ResNet:
...
def resnet152_aacn(pretrained: bool = False, **kwargs: Any) -> ResNet:
...
def resnext50_32x4d_aacn(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
def resnext101_32x8d_aacn(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
def wide_resnet50_2_aacn(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
def wide_resnet101_2_aacn(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
if __name__ == '__main__':
    ...
    model = resnet152_aacn(attention=attention, num_classes=num_classes).to(device)
