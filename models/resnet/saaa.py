...
__all__ = ['ResNet', 'resnet18_saaa', 'resnet34_saaa', 'resnet50_saaa', 'resnet101_saaa', 'resnet152_saaa',
           'resnext50_32x4d_saaa', 'resnext101_32x8d_saaa', 'wide_resnet50_2_saaa', 'wide_resnet101_2_saaa']
...
def resnext50_32x4d_saaa(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
def resnext101_32x8d_saaa(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
def wide_resnet50_2_saaa(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
def wide_resnet101_2_saaa(pretrained: bool = True, **kwargs: Any) -> ResNet:
...
if __name__ == '__main__':
    ...
    model = resnet152_saaa(pretrained=False, attention=attention, num_classes=num_classes).to(device)
